...
The icons are designed on a 20x20 grid, although the visual weight of the icons
...
Icon badges are 7x7 and aligned to the bottom right corner of the 16x16 area,
...
9. Remove unnecessary attributes from the SVG file (`id`, `data-name`, `class`,
   `defs`)
