import { MenuBehavior, WINDOW_PADDING, TOP_MENU_OFFSET, LEFT_MENU_OFFSET, } from './MenuInternal.svelte';
// ========================================
 ...
 */
export function calculatePosition(depth, parentItemRect, menuRect, behavior, relativeDistance) {
    const coords = {
        x: 0,
        y: 0,
...
export function addSubMenu(behavior, propItems, activeMenus, activeMenusMeta, menu, index) {
    ...
    const [activeMenu, activeMenuMeta] = createActiveMenu(behavior, index, parentItemRect, [...currentMenu.menuPath, index], // Extend path to include current item
    propItems);
